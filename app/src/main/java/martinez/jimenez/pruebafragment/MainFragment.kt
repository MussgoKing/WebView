package martinez.jimenez.pruebafragment
...
class MainFragment : Fragment() {
    ...
    private var etUr:EditText? = null
    private var btnIr:Button? = null
    ...
    override fun onCreateView(
        ...
        val miVista = inflater.inflate(R.layout.fragment_main, container, false)
        //Instancia de widgets
        etUr = miVista.findViewById(R.id.etUrl)
        btnIr = miVista.findViewById(R.id.ir)
        ...
        btnIr!!.setOnClickListener{
            var url = etUr!!.text.toString().trim()
            var urlFinal = ""
